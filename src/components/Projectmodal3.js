  ...
  return(
    <div className={`modal ${displayFlag ? '' : 'blind'}`} onClick={(e) => {modalFlagCon('prj3')}}>
      <div className="modal-inner" onClick={(e) => {e.stopPropagation(); e.preventDefault();}} id='prj3modal'>
        <p className='close-btn' onClick={(e) => {modalFlagCon('prj3')}}>X</p>
        ...
        <div className='modal-project-shotimg'>
          <img className='project-shot-item' alt='프로젝트 이미지1' src={require('../assets/img/project-shot/funding/shot1.png')}/>
          <img className='project-shot-item' alt='프로젝트 이미지2' src={require('../assets/img/project-shot/funding/shot2.png')}/>
          <img className='project-shot-item' alt='프로젝트 이미지3' src={require('../assets/img/project-shot/funding/shot3.png')}/>
          <img className='project-shot-item' alt='프로젝트 이미지4' src={require('../assets/img/project-shot/funding/shot4.png')}/>
          <img className='project-shot-item' alt='프로젝트 이미지5' src={require('../assets/img/project-shot/funding/shot5.png')}/>
          <img className='project-shot-item' alt='프로젝트 이미지6' src={require('../assets/img/project-shot/funding/shot6.png')}/>
        </div>
